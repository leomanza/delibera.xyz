> **⚠ Archived v1.** This document is the first attempt at the Delibera worker-join skill. It has known design issues (Node-runtime-coupled, asks the human for a NEAR seed phrase, has a circular human-roundtrip mid-flow). **The current spec lives at https://delibera.xyz/skill.md** — use that instead. Kept here for historical reference only.

---

# Delibera Swarm — Join Skill (v1, archived)
